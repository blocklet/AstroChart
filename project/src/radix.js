...
(function (astrology) {
  ...
  astrology.Radix.prototype.drawUniverse = function () {
    ...
    var wrapper = astrology.utils.getEmptyWrapper(
      universe,
      astrology._paperElementId + "-" + astrology.ID_RADIX + "-" + astrology.ID_SIGNS,
    );
    ...
    for (
      ...
      segment.setAttribute(
        "id",
        astrology._paperElementId + "-" + astrology.ID_RADIX + "-" + astrology.ID_SIGNS + "-" + i,
      );
  ...
  astrology.Radix.prototype.drawPoints = function () {
    ...
    var wrapper = astrology.utils.getEmptyWrapper(
      universe,
      astrology._paperElementId + "-" + astrology.ID_RADIX + "-" + astrology.ID_POINTS,
    );
  ...
  astrology.Radix.prototype.drawAxis = function () {
    ...
    [AS, IC, DC, MC].forEach(function (i) {
      ...
      if (i == AS) {
        ...
        wrapper.appendChild(
          this.paper.getSymbol(astrology.SYMBOL_AS, textPosition.x, textPosition.y),
        );
      }
      ...
      if (i == DC) {
        ...
        wrapper.appendChild(
          this.paper.getSymbol(astrology.SYMBOL_DS, textPosition.x, textPosition.y),
        );
      }
      ...
      if (i == IC) {
        ...
        wrapper.appendChild(
          this.paper.getSymbol(astrology.SYMBOL_IC, textPosition.x, textPosition.y),
        );
      }
      ...
      if (i == MC) {
        ...
        wrapper.appendChild(
          this.paper.getSymbol(astrology.SYMBOL_MC, textPosition.x, textPosition.y),
        );
      }
    }, this);
  };
  ...
  astrology.Radix.prototype.drawCusps = function () {
    ...
    var wrapper = astrology.utils.getEmptyWrapper(
      universe,
      astrology._paperElementId + "-" + astrology.ID_RADIX + "-" + astrology.ID_CUSPS,
    );
  ...
  astrology.Radix.prototype.drawRuler = function drawRuler() {
    ...
    var wrapper = astrology.utils.getEmptyWrapper(
      universe,
      astrology._paperElementId + "-" + astrology.ID_RADIX + "-" + astrology.ID_RULER,
    );
  ...
  astrology.Radix.prototype.drawCircles = function drawCircles() {
    ...
    var wrapper = astrology.utils.getEmptyWrapper(
      universe,
      astrology._paperElementId + "-" + astrology.ID_RADIX + "-" + astrology.ID_CIRCLES,
    );
